...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const setText = (elementId: string, value: string | null) => {
  ...
  const setImageSrc = (elementId: string, value: string | null) => {
    const element = document.getElementById(elementId) as HTMLImageElement; // Cast to HTMLImageElement
    if (element && value) {
      element.src = value;
